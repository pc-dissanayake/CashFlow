...
// Background Template Selector (client-side, non-print)
?>
<div class="mb-3 no-print" style="padding:0 20px 10px 20px;">
    <label class="form-label"><i class="bi bi-image"></i> Background Template</label>
    <div class="row g-3" id="bgTemplateSelectorPdf">
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="none" class="d-none" <?= $bgTemplate === 'none' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="basic" class="d-none" <?= $bgTemplate === 'basic' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="blue-cream-minimalist" class="d-none" <?= $bgTemplate === 'blue-cream-minimalist' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="modern-elegant" class="d-none" <?= $bgTemplate === 'modern-elegant' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="blue-white-minimalist" class="d-none" <?= $bgTemplate === 'blue-white-minimalist' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="blue-modern-medical" class="d-none" <?= $bgTemplate === 'blue-modern-medical' ? 'checked' : '' ?>>
        ...
        <div class="col-auto">
            <label class="bg-template-option">
                <input type="radio" name="background_template_pdf" value="blue-white-geometric" class="d-none" <?= $bgTemplate === 'blue-white-geometric' ? 'checked' : '' ?>>
...
(function() {
    function initBgSelectorPdf() {
        ...
        const preview = document.querySelector('.invoice-page');
        ...
        document.querySelectorAll('#bgTemplateSelectorPdf input[name="background_template_pdf"]').forEach(r => {
        ...
        const current = document.querySelector('#bgTemplateSelectorPdf input[name="background_template_pdf"]:checked');
        if (current) applyTemplate(current.value);
    }
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initBgSelectorPdf);
    } else {
        initBgSelectorPdf();
    }
})();
...
<div class="invoice-page" style="<?= $hasBackground ? 'background-image:url(' . htmlspecialchars($bgUrl) . ');background-size:cover;background-position:center;background-repeat:no-repeat;' : '' ?>">
    ...
    <div class="doc-footer">
        ...
        <div class="legal">
            <span style="font-size: 0.9rem;">This document is digitally generated and signed by <?= htmlspecialchars($invoice['company_name']) ?>.
